...
_Next free ID: EM-272. (EM-240 = crime engine; EM-241/242 reserved for EM-240 follow-ons; EM-249–263 = Wave O society; EM-264–266 = Wave P building layout — **shipped then superseded**, archived in COMPLETED-WORK; EM-267 = agent-invented ideologies; EM-268–271 = free-placement + settlements redo, supersedes Wave P placement.)_
