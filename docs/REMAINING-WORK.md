...
_Next free ID: EM-300. (EM-297–299 = **Wave Q world-authorship** first slice — research-v5 shortlist (corrected by v5-1), filed 2026-07-06: EM-297 divergence probe → EM-298 facades warm-up → EM-299 parametric-grammar keystone. The report's other 7 directions were deliberately NOT filed — 300–302/305 held to FUTURE, 303/304 fold into Wave O, 306 into EM-112/119, 307 trims to a camera. EM-240 = crime engine; EM-241/242 reserved for EM-240 follow-ons; EM-249–263 = Wave O society; EM-264–266 = Wave P building layout — **shipped then superseded**, archived in COMPLETED-WORK; EM-267 = agent-invented ideologies; EM-268–271 = free-placement + settlements redo (supersedes Wave P placement); EM-272–296 = **W29 offline-review remediation** — the PRs #49–69 deep review 2026-07-01 (9 of its 33 distinct findings shipped in #70); **all 25 fixed + QE-gated 2026-07-03 (PR #74)**, archived in COMPLETED-WORK.)_
