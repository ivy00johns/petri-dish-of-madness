...
- **EM-239 + EM-243–248 (Wave N — Agent-Controlled City Layout)** entered 2026-06-27 via
  ...
  **Three locked pillars:** authorship = agents, emergently (backend event-sourced state + verbs);
  ...
  EM-243–248 now unblocked. **EM-243** (S2 `build_road` + nearby_layout) **✅ shipped 2026-06-28, PR #60**
  (agents grow the road graph live; EM-155-safe) and **EM-248** (S5b asset/pool variety) **✅ shipped
  2026-06-27, PR #59**. W24 remaining: **EM-244** (S3a demolish/car-policy, now unblocked by EM-243),
  **EM-246** (S4 templates); EM-247 gates EM-245 + the geometric EM-246 presets.
